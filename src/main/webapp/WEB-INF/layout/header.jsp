<%-- 
    Document   : header
    Created on : Apr 28, 2021, 9:52:42 AM
    Author     : btson
--%>
...
<div style="background-color: #181818; text-align: center">
    <fast-anchor href="/NhaHangTiecCuoi" appearance="lightweight" style="font-size: 20px ; padding-right: 25px; padding-top: 25px">Trang chủ</fast-anchor>
